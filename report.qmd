...
# data description for the tourism dataset

tourism_desc <- data.frame(
  VariableName = c("Quarter", "Region", "Purpose", "Trips"),
  DataType = c("yearquarter", "character", "character", "numeric"),
  Explanation = c(
    "A combination of year and quarter, representing timestamps.",
    "Text characters denoting region or area names.",
    "Text characters related to the purpose or usage.",
    "Numerical data representing quantities (e.g., trip counts)."
  )
)

kable(tourism_desc, format = "html", caption = "Variable Information") %>%
