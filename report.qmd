...
```{r}
#| label: fig-fivenum
#| fig-cap: "Representation of five number summary of values in the dataset"
...
By analyzing these statistics in @fig-fivenum, we can get an overview of the distribution of latitudes and longitudes in the dataset. 
...
ggplot(population_count, aes(x = year, y = count)) +
...
Based on our detailed analysis of the Coastal Taipans sightigs, following are our key takeaways:
