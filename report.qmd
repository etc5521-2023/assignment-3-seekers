...
- **Then, we merged the tourism dataset with our wild sighting data and investigated whether there was any significant relationship between tourism activity in a specific location and the number of occurrences of wild species sightings.**
- **Upon visualizing the joined data and conducting a more precise analysis using permutation tests, we asked the input of 8 individuals to check if there are any variations within the visuals. But, only one of them were able to identify any distinctions among the visual representations, that was just by chance and have no valid reason to support it.**
- **This hypothesis testing leaves us with the p-value of 1 because of which we fail to reject the null hypothesis which is $H_o$ (null hypothesis): There is no association between popularity of
